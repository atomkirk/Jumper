#
#  Be sure to run `pod spec lint Jumper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Jumper"
  s.version      = "0.0.1"
  s.summary      = "Small extension to Date for 95% of use cases"
  ...
  s.homepage     = "https://github.com/atomkirk/Jumper"
  ...
  # Or just: s.author    = "Adam Kirk"
  # s.authors            = { "Adam Kirk" => "atomkirk@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Adam Kirk"
  ...
  s.source       = { :git => "https://github.com/atomkirk/Jumper.git", :tag => "v#{s.version}" }
